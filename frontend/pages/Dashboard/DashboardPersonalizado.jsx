          ...
          <div className="grid">
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <Card className="h-full">
                <div className="flex align-items-center justify-content-between mb-3">
                  <div>
                    <span className="block text-500 font-medium mb-3">Partidos Próximos</span>
                    <div className="text-900 font-medium text-xl">{dashboardData.stats.upcomingMatches}</div>
                  </div>
                  <div className="flex align-items-center justify-content-center bg-blue-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                    <i className="pi pi-calendar text-blue-500 text-xl"></i>
                  </div>
                </div>
                <span className="text-green-500 font-medium">+2 esta semana</span>
              </Card>
            </div>
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <Card className="h-full">
                <div className="flex align-items-center justify-content-between mb-3">
                  <div>
                    <span className="block text-500 font-medium mb-3">Canchas Disponibles</span>
                    <div className="text-900 font-medium text-xl">{dashboardData.stats.availableCourts}</div>
                  </div>
                  <div className="flex align-items-center justify-content-center bg-green-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                    <i className="pi pi-building text-green-500 text-xl"></i>
                  </div>
                </div>
                <span className="text-green-500 font-medium">75% disponibles</span>
              </Card>
            </div>
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <Card className="h-full">
                <div className="flex align-items-center justify-content-between mb-3">
                  <div>
                    <span className="block text-500 font-medium mb-3">Miembros del Equipo</span>
                    <div className="text-900 font-medium text-xl">{dashboardData.stats.teamMembers}</div>
                  </div>
                  <div className="flex align-items-center justify-content-center bg-purple-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                    <i className="pi pi-users text-purple-500 text-xl"></i>
                  </div>
                </div>
                <span className="text-green-500 font-medium">Equipo completo</span>
              </Card>
            </div>
            ...
            <div className="col-12 md:col-6 lg:col-3">
              <Card className="h-full">
                <div className="flex align-items-center justify-content-between mb-3">
                  <div>
                    <span className="block text-500 font-medium mb-3">Tasa de Victoria</span>
                    <div className="text-900 font-medium text-xl">{dashboardData.stats.winRate}%</div>
                  </div>
                  <div className="flex align-items-center justify-content-center bg-orange-100 border-round" style={{ width: '2.5rem', height: '2.5rem' }}>
                    <i className="pi pi-trophy text-orange-500 text-xl"></i>
                  </div>
                </div>
                <span className="text-green-500 font-medium">+5% este mes</span>
              </Card>
            </div>
                ...
                <div className="grid">
                  <div className="col-12 md:col-6">
                    <div className="text-center mb-4">
                      <div className="text-900 font-bold text-3xl mb-2">{dashboardData.stats.totalGoals}</div>
                      <div className="text-500">Goles Totales</div>
                      <div className="text-600 text-sm mt-1">1.3 por partido</div>
                    </div>
                  </div>
                  <div className="col-12 md:col-6">
                    <div className="text-center mb-4">
                      <div className="text-900 font-bold text-3xl mb-2">{dashboardData.stats.assists}</div>
                      <div className="text-500">Asistencias</div>
                      <div className="text-600 text-sm mt-1">1.0 por partido</div>
                    </div>
                  </div>
                  <div className="col-12 md:col-6">
                    <div className="text-center mb-4">
                      <div className="text-900 font-bold text-3xl mb-2">12</div>
                      <div className="text-500">Partidos Ganados</div>
                      <ProgressBar value={75} className="mt-2" />
                    </div>
                  </div>
                  <div className="col-12 md:col-6">
                    <div className="text-center mb-4">
                      <div className="text-900 font-bold text-3xl mb-2">4</div>
                      <div className="text-500">Partidos Perdidos</div>
                  ...
                  <Timeline 
                    ...
                    content={(item) => (
                      <div className="flex align-items-center">
                        <i className={`${item.icon} text-${item.status === 'success' ? 'green' : item.status === 'warning' ? 'orange' : 'blue'}-500 mr-3`}></i>
                        <span className="text-900">{item.content}</span>
                      </div>
                    )}
                  />
                </ScrollPanel>
                ...
                <div className="grid">
                  {dashboardData.teamMembers.map((member, index) => (
                    <div key={member.id} className="col-12 md:col-6 lg:col-3">
                      <Panel header={`#${index + 1} ${member.name}`} toggleable>
                        <div className="flex align-items-center justify-content-between mb-3">
                          <div className="flex align-items-center">
                            <Avatar 
                              image={member.avatar}
                        ...
                        <div className="grid">
                          <div className="col-6 text-center">
                            <div className="text-900 font-bold">{member.goals}</div>
                            <div className="text-500 text-sm">Goles</div>
                          </div>
                          <div className="col-6 text-center">
                            <div className="text-900 font-bold">{member.assists}</div>
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-column">
        {/* Header Principal */}
        <div className="bg-white border-bottom-1 border-200 px-4 py-3 flex align-items-center justify-content-between">
          <div className="flex align-items-center">
            <Button
              icon="pi pi-bars"
              text
              onClick={() => setSidebarVisible(!sidebarVisible)}
              className="mr-3 text-600"
            />

...
export default function DashboardResponsivo() {
  const [sidebarVisible, setSidebarVisible] = useState(false); // Cambiado a false por defecto para móviles
        ...
        <div className="relative p-3 md:p-4">
          <div className="flex align-items-center justify-content-between mb-3">
            <div className="flex-1">
              <span className="block text-600 font-medium mb-2 text-xs md:text-sm">{title}</span>
              <div className="text-900 font-bold text-2xl md:text-3xl mb-1">{value}</div>
              {subtitle && (
                <div className="text-500 text-xs md:text-sm">{subtitle}</div>
              )}
            </div>
            <div 
            ...
            >
              <i className={`${icon} ${isMobile ? 'text-xl' : 'text-2xl'}`}></i>
            </div>
          </div>
          ...
          {trend && (
            <div className="flex align-items-center">
              ...
              <span className={`text-${trend > 0 ? 'green' : 'red'}-500 font-medium text-xs md:text-sm`}>
    ...
    switch (activeMenuItem) {
      case 'dashboard':
        return (
          <div className="grid">
            ...
            {/* Card de Rendimiento Responsiva */}
            <div className="col-12 lg:col-8">
              <Card className="border-none shadow-2">
                <div className="p-3 md:p-4">
                  <div className="flex align-items-center justify-content-between mb-4">
                    <h3 className="text-900 font-bold text-lg md:text-xl m-0">Rendimiento del Equipo</h3>
                    <Button 
                  ...
                  <div className="grid">
                    <div className="col-12 md:col-4">
                      <div className="text-center p-3 md:p-4 border-round" style={{ backgroundColor: '#f0fdf4' }}>
                        <div className="text-900 font-bold text-3xl md:text-4xl mb-2" style={{ color: '#22c55e' }}>
                          {dashboardData.stats.totalGoals}
                        </div>
                        <div className="text-600 font-medium mb-1 text-sm md:text-base">Goles Totales</div>
                        <div className="text-500 text-xs md:text-sm">1.3 por partido</div>
                        <ProgressBar 
                          value={80} 
                    ...
                    <div className="col-12 md:col-4">
                      <div className="text-center p-3 md:p-4 border-round" style={{ backgroundColor: '#fef3c7' }}>
                        <div className="text-900 font-bold text-3xl md:text-4xl mb-2" style={{ color: '#f59e0b' }}>
                          {dashboardData.stats.assists}
                        </div>
                        <div className="text-600 font-medium mb-1 text-sm md:text-base">Asistencias</div>
                        <div className="text-500 text-xs md:text-sm">1.0 por partido</div>
                        <ProgressBar 
                          value={70} 
                          style={{ height: '6px', marginTop: '10px' }}
                          color="#f59e0b"
                    ...
                    <div className="col-12 md:col-4">
                      <div className="text-center p-3 md:p-4 border-round" style={{ backgroundColor: '#dbeafe' }}>
                        <div className="text-900 font-bold text-3xl md:text-4xl mb-2" style={{ color: '#3b82f6' }}>
                          12
                        </div>
                        <div className="text-600 font-medium mb-1 text-sm md:text-base">Partidos Ganados</div>
                        <div className="text-500 text-xs md:text-sm">75% de victorias</div>
                        <ProgressBar 
                          value={75} 
                          style={{ height: '6px', marginTop: '10px' }}
                          color="#3b82f6"
            ...
            {/* Timeline de Actividades Responsiva */}
            <div className="col-12 lg:col-4">
              <Card className="border-none shadow-2 h-full">
                <div className="p-3 md:p-4">
                  <div className="flex align-items-center justify-content-between mb-4">
                    <h3 className="text-900 font-bold text-lg md:text-xl m-0">Actividad Reciente</h3>
                    <Button 
                      icon="pi pi-refresh" 
                      size="small" 
                      text 
                  ...
                  <ScrollPanel style={{ height: isMobile ? '250px' : '300px' }}>
                    <Timeline 
                      value={dashboardData.activities} 
                      content={(item) => (
                        <div className="flex align-items-start p-2 md:p-3 border-round hover:bg-gray-50 transition-colors transition-duration-200">
                          <div 
                          ...
                          <div className="flex-1">
                            <span className="text-900 font-medium text-xs md:text-sm">{item.content}</span>
            ...
            {/* Top Jugadores Responsivo */}
            <div className="col-12">
              <Card className="border-none shadow-2">
                <div className="p-3 md:p-4">
                  <div className="flex align-items-center justify-content-between mb-4">
                    <h3 className="text-900 font-bold text-lg md:text-xl m-0">Top Jugadores</h3>
                    <Button 
                      label={isMobile ? "" : "Ver Todos"} 
                      icon="pi pi-users" 
                      size="small" 
                      text 
                      className="p-button-sm"
                  ...
                  <div className="grid">
                    {dashboardData.teamMembers.map((member, index) => (
                      <div key={member.id} className="col-12 sm:col-6 lg:col-3">
                        <Panel 
                          header={
                            <div className="flex align-items-center">
                              <div 
                              ...
                              <span className="font-bold text-900 text-sm md:text-base">{member.name}</span>
                            </div>
                          } 
                          toggleable
                          className="h-full"
                        >
                          <div className="flex align-items-center justify-content-between mb-3">
                            <div className="flex align-items-center">
                              ...
                              />
                              <div>
                                <div className="font-medium text-900 text-sm md:text-base">{member.name}</div>
                                <div className="text-500 text-xs md:text-sm">{member.position}</div>
                              </div>
                            </div>
                            <Tag value={`⭐ ${member.rating}`} severity="info" />
                          </div>
                          <div className="grid">
                            <div className="col-6 text-center p-2 md:p-3 border-round" style={{ backgroundColor: '#f0fdf4' }}>
                              <div className="text-900 font-bold text-lg md:text-xl" style={{ color: '#22c55e' }}>{member.goals}</div>
                              <div className="text-500 text-xs md:text-sm">Goles</div>
                            </div>
                            <div className="col-6 text-center p-2 md:p-3 border-round" style={{ backgroundColor: '#fef3c7' }}>
                              <div className="text-900 font-bold text-lg md:text-xl" style={{ color: '#f59e0b' }}>{member.assists}</div>
                              <div className="text-500 text-xs md:text-sm">Asistencias</div>
                            </div>
                          </div>
                        </Panel>
                      </div>
      ...
      case 'matches':
        return (
          <Card className="border-none shadow-2">
            <div className="p-3 md:p-4">
              <div className="flex flex-column md:flex-row align-items-start md:align-items-center justify-content-between mb-4 gap-2">
                <h3 className="text-900 font-bold text-lg md:text-xl m-0">Partidos Programados</h3>
                <Button 
                  label={isMobile ? "" : "Programar Nuevo Partido"} 
                  icon="pi pi-plus"
              ...
              <div className="overflow-x-auto">
                <DataTable 
                  ...
                  scrollable
                  scrollHeight={isMobile ? "400px" : "auto"}
                >
      ...
      case 'courts':
        return (
          <Card className="border-none shadow-2">
            <div className="p-3 md:p-4">
              <div className="flex flex-column md:flex-row align-items-start md:align-items-center justify-content-between mb-4 gap-2">
                <h3 className="text-900 font-bold text-lg md:text-xl m-0">Canchas Disponibles</h3>
                <Button 
                  label={isMobile ? "" : "Reservar Cancha"} 
      ...
      case 'challenges':
        return (
          <Card className="border-none shadow-2">
            <div className="p-3 md:p-4">
              <div className="flex flex-column md:flex-row align-items-start md:align-items-center justify-content-between mb-4 gap-2">
                <h3 className="text-900 font-bold text-lg md:text-xl m-0">Sistema de Retos</h3>
                <Button 
                  label={isMobile ? "" : "Crear Nuevo Reto"} 
                  icon="pi pi-plus"
                  className="p-button-success"
                  size={isMobile ? "small" : "normal"}
                />
                      ...
                      <Panel key={i} header={`Reto #${i} - Equipo Los Tigres`} toggleable>
                        <div className="grid">
                          <div className="col-12 md:col-6">
                            <p className="text-sm md:text-base"><strong>Fecha:</strong> 25 de Enero, 2024</p>
                            <p className="text-sm md:text-base"><strong>Hora:</strong> 15:00</p>
                            <p className="text-sm md:text-base"><strong>Cancha:</strong> Cancha Central</p>
                          </div>
                          <div className="col-12 md:col-6">
                            <p className="text-sm md:text-base"><strong>Modalidad:</strong> Fútbol 8</p>
                            <p className="text-sm md:text-base"><strong>Apuesta:</strong> $50,000</p>
                            <p className="text-sm md:text-base"><strong>Estado:</strong> Pendiente</p>
                          </div>
                          <div className="col-12 flex flex-column sm:flex-row gap-2 mt-3">
                            <Button label="Aceptar" icon="pi pi-check" className="p-button-success" size="small" />
                            <Button label="Rechazar" icon="pi pi-times" className="p-button-danger" size="small" />
                            <Button label="Negociar" icon="pi pi-comments" className="p-button-info" size="small" />
                          </div>
                        </div>
                      </Panel>
                    ))}
                  ...
                  <div className="flex flex-column gap-3">
                    {[1, 2].map(i => (
                      <Panel key={i} header={`Reto #${i} - Equipo Alpha`} toggleable>
                        <div className="grid">
                          <div className="col-12 md:col-6">
                            <p className="text-sm md:text-base"><strong>Fecha:</strong> 28 de Enero, 2024</p>
                            <p className="text-sm md:text-base"><strong>Hora:</strong> 18:00</p>
                            <p className="text-sm md:text-base"><strong>Cancha:</strong> Cancha Norte</p>
                          </div>
                          <div className="col-12 md:col-6">
                            <p className="text-sm md:text-base"><strong>Modalidad:</strong> Fútbol 11</p>
                            <p className="text-sm md:text-base"><strong>Apuesta:</strong> $100,000</p>
                            <p className="text-sm md:text-base"><strong>Estado:</strong> Esperando respuesta</p>
                          </div>
                          <div className="col-12 flex flex-column sm:flex-row gap-2 mt-3">
                            <Button label="Cancelar" icon="pi pi-times" className="p-button-danger" size="small" />
                            <Button label="Modificar" icon="pi pi-pencil" className="p-button-warning" size="small" />
                          </div>
                        </div>
                      </Panel>
                    ))}
        ...
        return (
          <Card className="border-none shadow-2">
            <div className="text-center py-6 md:py-8">
              ...
              >
                <i className={`pi pi-cog ${isMobile ? 'text-2xl' : 'text-3xl'}`}></i>
              </div>
              <h3 className="text-600 mb-2 text-lg md:text-xl">
                {activeMenuItem.charAt(0).toUpperCase() + activeMenuItem.slice(1).replace('-', ' ')}
              </h3>
              <p className="text-500 text-sm md:text-base">Esta funcionalidad estará disponible próximamente</p>
            </div>
          </Card>
        );
    }
  ...
  return (
    <div className="flex min-h-screen" style={{ backgroundColor: '#f8fafc' }}>
      ...
      <div className="flex-1 flex flex-column">
        ...
        <div 
          className="px-3 md:px-4 py-2 md:py-3 flex align-items-center justify-content-between border-bottom-1 border-200"
          style={{ 
        ...
        >
          <div className="flex align-items-center">
            <Button
              ...
              className="mr-2 md:mr-3 text-600 hover:text-900 transition-colors transition-duration-200"
            />
            <h2 className="text-900 m-0 font-bold text-lg md:text-xl">

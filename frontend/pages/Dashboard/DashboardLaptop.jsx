...
export default function DashboardLaptop() {
  ...
  // Detectar tamaño de pantalla específico para laptops
  useEffect(() => {
  ...
  const renderDashboardContent = () => {
    switch (activeMenuItem) {
      case 'dashboard':
        return (
          <div className="grid">
            {/* Métricas Principales Optimizadas para Laptop */}
            ...
            {/* Card de Rendimiento Optimizada para Laptop */}
            ...
            {/* Top Jugadores Optimizado para Laptop */}
  ...
  return (
    <div className="flex min-h-screen" style={{ backgroundColor: '#f8fafc' }}>
      ...
      <div className="flex-1 flex flex-column">
        {/* Header Principal Optimizado para Laptop */}
        <div 
